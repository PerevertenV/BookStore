...
namespace JustStoreMVC.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int orderId)
        {
            ...
            orderVM = new()
            {
                OrderHeader = _mapper.Map<OrderHeader>(orderHeaderFromDb),
                OrderDetail = _mapper.Map<IEnumerable<OrderDetail>>(orderDetailFromDb)
            };
		...
		{
			orderVM.OrderHeader = _mapper.Map<OrderHeader>(_unitOfWork.OrderHeader.GetFirstOrDefault(u => 
            u.Id == orderVM.OrderHeader.Id, includeProperties: "ApplicationUser"));

			orderVM.OrderDetail = _mapper.Map<IEnumerable<OrderDetail>>(_unitOfWork.OrderDetail.GetAll(u => 
        ...
        public IActionResult GetAll(string status)
        {
            ...
            {
                ObjectsFromDb = _mapper.Map<List<OrderHeader>>(_unitOfWork.OrderHeader
            ...
            else 
            {
                ...
                ObjectsFromDb =_mapper.Map<IEnumerable<OrderHeader>>( _unitOfWork.OrderHeader.GetAll(u => 
