...
namespace JustStoreMVC.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
	{
        ...
        public IActionResult Index()
		{
            ...
            ShoppingCartVM = new()
            {
                ShoppingCartList = _mapper.Map<IEnumerable<ShoppingCart>>(cartFromDb),
                OrderHeader = new()
            };

            IEnumerable<ProductImage> productImages = _mapper.Map <IEnumerable<ProductImage>>(_unitOfWork.ProductImages
                .GetAll());
        ...
        public IActionResult Summary() 
        {
            ...
            ShoppingCartVM.OrderHeader.ApplicationUser = _mapper.Map<ApplicationUser>(_unitOfWork.ApplicationUser
        ...
        public IActionResult SummaryPOST() 
        {
            ...
            ShoppingCartVM.ShoppingCartList = _mapper.Map<IEnumerable<ShoppingCart>>(_unitOfWork.ShoppingCart
                .GetAll(u => u.ApplicationUserId == userID, includeProperties: "Product"));

            ShoppingCartVM.OrderHeader.OrderDate = DateTime.Now;
            ShoppingCartVM.OrderHeader.ApplicationUserId = userID;

            ApplicationUser appUser = _mapper.Map<ApplicationUser>(_unitOfWork.ApplicationUser
                .GetFirstOrDefault(u=>u.Id == userID));
            ...
            OrderHeaderEntity dbOrderHeader = _mapper.Map<OrderHeaderEntity>(ShoppingCartVM.OrderHeader);
            _unitOfWork.OrderHeader.Add(dbOrderHeader);
            _unitOfWork.save();

            ShoppingCartVM.OrderHeader.Id = dbOrderHeader.Id;
            ...
            foreach (var cart in ShoppingCartVM.ShoppingCartList) 
            {
                ...
                _unitOfWork.OrderDetail.Add(_mapper.Map<OrderDetailsEntity>(orderDetail));
                _unitOfWork.save();
            }
        ...
        {
            OrderHeader orderHeader = _mapper.Map<OrderHeader>(_unitOfWork.OrderHeader.GetFirstOrDefault( u 
                => u.Id == Id, includeProperties:"ApplicationUser"));
            ...
            List<ShoppingCartEntity> shoppingCarts =  _unitOfWork.ShoppingCart
